...
=======
  getSmartphones(): Observable<Product[]> {
    return this.http.get<Product[]>('http://127.0.0.1:8000/api/products/phones/')
  }

  getTablets(): Observable<Product[]> {
    return this.http.get<Product[]>('http://127.0.0.1:8000/api/products/tablets/')
  }

  getWatches(): Observable<Product[]> {
    return this.http.get<Product[]>('http://127.0.0.1:8000/api/products/watches/')
  }

  getAccessories(): Observable<Product[]> {
    return this.http.get<Product[]>('http://127.0.0.1:8000/api/products/accessories/')
  }
